...
- `--mode [socket|tcp|pipe|stdio]`
   ...
   The mode to use for the debug launch server. *NOTE:* This option is mutually exclusive with options: socket, tcp, pipe, stdio.  [env var: ROBOTCODE_MODE; default: STDIO]
